...
var Button = () => {
  return /* @__PURE__ */ jsx("button", { children: "Web Button" });
};
...
var UIProvider = ({
  ...
  return /* @__PURE__ */ jsx2(ThemeProvider, { theme: resolvedTheme, children: /* @__PURE__ */ jsx2(ThemeContext.Provider, { value: resolvedTheme, children }) });
};
function useTheme() {
